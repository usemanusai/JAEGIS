...
class CommandManager {
    ...
    async registerCommands(context) {
        const commands = [
            ...
            vscode.commands.registerCommand('bmad.activateDocumentationMode', () => this.activateMode('documentation')),
            vscode.commands.registerCommand('bmad.activateFullDevelopmentMode', () => this.activateMode('fullDevelopment')),
            vscode.commands.registerCommand('bmad.continueProject', () => this.activateMode('continueProject')),
            vscode.commands.registerCommand('bmad.taskOverview', () => this.activateMode('taskOverview')),
            vscode.commands.registerCommand('bmad.debugMode', () => this.activateMode('debugMode')),
            vscode.commands.registerCommand('bmad.continuousExecution', () => this.activateMode('continuousExecution')),
            vscode.commands.registerCommand('bmad.featureGapAnalysis', () => this.activateMode('featureGapAnalysis')),
            vscode.commands.registerCommand('bmad.githubIntegration', () => this.activateMode('githubIntegration')),
            // Quick mode selection
            vscode.commands.registerCommand('bmad.quickModeSelect', () => this.showQuickModeSelector()),
            // Workspace analysis commands
            vscode.commands.registerCommand('bmad.scanWorkspace', () => this.scanWorkspace()),
            vscode.commands.registerCommand('bmad.autoSetup', () => this.autoSetup()),
            vscode.commands.registerCommand('bmad.detectStack', () => this.detectTechStack()),
            // Agent management commands
            vscode.commands.registerCommand('bmad.selectAgents', () => this.showAgentSelector()),
            vscode.commands.registerCommand('bmad.agentHandoff', () => this.performAgentHandoff()),
            // Utility commands
            vscode.commands.registerCommand('bmad.healthCheck', () => this.performHealthCheck()),
            vscode.commands.registerCommand('bmad.showProgress', () => this.showProgressDetails()),
            vscode.commands.registerCommand('bmad.showModeDetails', () => this.showModeDetails()),
            vscode.commands.registerCommand('bmad.showErrorDetails', () => this.showErrorDetails()),
            // Augment integration commands
            vscode.commands.registerCommand('bmad.debugCurrentFile', () => this.debugCurrentFile()),
            vscode.commands.registerCommand('bmad.documentCurrentFile', () => this.documentCurrentFile()),
            vscode.commands.registerCommand('bmad.debugSelection', () => this.debugSelection()),
            vscode.commands.registerCommand('bmad.explainCode', () => this.explainCode()),
            vscode.commands.registerCommand('bmad.generateTests', () => this.generateTests()),
            vscode.commands.registerCommand('bmad.analyzeFolder', () => this.analyzeFolder()),
            vscode.commands.registerCommand('bmad.generateDocsForFolder', () => this.generateDocsForFolder()),
            vscode.commands.registerCommand('bmad.refreshAnalysis', () => this.refreshAnalysis()),
            vscode.commands.registerCommand('bmad.openSettings', () => this.openSettings()),
            vscode.commands.registerCommand('bmad.showHelp', () => this.showHelp()),
            // Dakota (Dependency Modernization) commands
            vscode.commands.registerCommand('bmad.dependencyAudit', () => this.performDependencyAudit()),
            vscode.commands.registerCommand('bmad.dependencyModernization', () => this.performDependencyModernization()),
            vscode.commands.registerCommand('bmad.startDependencyMonitoring', () => this.startDependencyMonitoring()),
            vscode.commands.registerCommand('bmad.stopDependencyMonitoring', () => this.stopDependencyMonitoring()),
            vscode.commands.registerCommand('bmad.checkSecurityVulnerabilities', () => this.checkSecurityVulnerabilities()),
            vscode.commands.registerCommand('bmad.updateOutdatedDependencies', () => this.updateOutdatedDependencies()),
            vscode.commands.registerCommand('bmad.generateDependencyReport', () => this.generateDependencyReport()),
            vscode.commands.registerCommand('bmad.analyzeDependencyLicenses', () => this.analyzeDependencyLicenses()),
            // Phoenix (Deployment & Containerization) commands
            vscode.commands.registerCommand('bmad.deploymentPreparation', () => this.performDeploymentPreparation()),
            vscode.commands.registerCommand('bmad.containerizeProject', () => this.containerizeProject()),
            vscode.commands.registerCommand('bmad.crossPlatformSetup', () => this.performCrossPlatformSetup()),
            vscode.commands.registerCommand('bmad.generateDeploymentScripts', () => this.generateDeploymentScripts()),
            vscode.commands.registerCommand('bmad.validateDeploymentConfig', () => this.validateDeploymentConfig()),
            vscode.commands.registerCommand('bmad.deploymentHealthCheck', () => this.performDeploymentHealthCheck()),
            vscode.commands.registerCommand('bmad.rollbackDeployment', () => this.performRollbackDeployment()),
            vscode.commands.registerCommand('bmad.deploymentDocumentation', () => this.generateDeploymentDocumentation()),
            // Chronos (Version Control & Token Management) commands
            vscode.commands.registerCommand('bmad.versionTracking', () => this.performVersionTracking()),
            vscode.commands.registerCommand('bmad.tokenMonitoring', () => this.performTokenMonitoring()),
            vscode.commands.registerCommand('bmad.modelUpdatesResearch', () => this.performModelUpdatesResearch()),
            vscode.commands.registerCommand('bmad.generateVersionChangelog', () => this.generateVersionChangelog()),
            vscode.commands.registerCommand('bmad.optimizeTokenUsage', () => this.optimizeTokenUsage()),
            vscode.commands.registerCommand('bmad.checkTokenLimits', () => this.checkTokenLimits()),
            vscode.commands.registerCommand('bmad.updateModelSpecs', () => this.updateModelSpecifications()),
            vscode.commands.registerCommand('bmad.generateTokenReport', () => this.generateTokenUsageReport()),
            // Sentinel (Task Completion & Quality Assurance) commands
            vscode.commands.registerCommand('bmad.taskCompletionMonitoring', () => this.performTaskCompletionMonitoring()),
            vscode.commands.registerCommand('bmad.checklistValidation', () => this.performChecklistValidation()),
            vscode.commands.registerCommand('bmad.qualityAssuranceReview', () => this.performQualityAssuranceReview()),
            vscode.commands.registerCommand('bmad.generateCompletionReport', () => this.generateCompletionReport()),
            vscode.commands.registerCommand('bmad.validateTaskCriteria', () => this.validateTaskCriteria()),
            vscode.commands.registerCommand('bmad.updateCompletionStatus', () => this.updateCompletionStatus()),
            vscode.commands.registerCommand('bmad.monitorQualityStandards', () => this.monitorQualityStandards()),
            vscode.commands.registerCommand('bmad.generateQualityAssessment', () => this.generateQualityAssessment()),
            // Meta-Orchestrator (Agent Squad Management & Evolution) commands
            vscode.commands.registerCommand('bmad.squadArchitectureMonitoring', () => this.performSquadArchitectureMonitoring()),
            vscode.commands.registerCommand('bmad.agentResearchIntelligence', () => this.performAgentResearchIntelligence()),
            vscode.commands.registerCommand('bmad.squadGenerationDesign', () => this.performSquadGenerationDesign()),
            vscode.commands.registerCommand('bmad.generateSquadSpecification', () => this.generateSquadSpecification()),
            vscode.commands.registerCommand('bmad.validateSquadProposal', () => this.validateSquadProposal()),
            vscode.commands.registerCommand('bmad.analyzeSquadEvolution', () => this.analyzeSquadEvolution()),
            vscode.commands.registerCommand('bmad.monitorAgentPerformance', () => this.monitorAgentPerformance()),
            vscode.commands.registerCommand('bmad.generateEvolutionReport', () => this.generateEvolutionReport()),
            // Agent Creator (AI Agent Creation & Generation) commands
            vscode.commands.registerCommand('bmad.conceptualizeAgent', () => this.conceptualizeAgent()),
            vscode.commands.registerCommand('bmad.generateAgent', () => this.generateAgent()),
            vscode.commands.registerCommand('bmad.deployAgent', () => this.deployAgent()),
            vscode.commands.registerCommand('bmad.generateAgentBrief', () => this.generateAgentBrief()),
            vscode.commands.registerCommand('bmad.validateAgentConcept', () => this.validateAgentConcept()),
            vscode.commands.registerCommand('bmad.analyzeAgentPerformance', () => this.analyzeAgentPerformance()),
            vscode.commands.registerCommand('bmad.researchAgentModels', () => this.researchAgentModels()),
            vscode.commands.registerCommand('bmad.generateDeploymentPlan', () => this.generateDeploymentPlan()),
            // Web Agent Creator (Web Agent Creation & UI Generation) commands
            vscode.commands.registerCommand('bmad.designWebAgentUI', () => this.designWebAgentUI()),
            vscode.commands.registerCommand('bmad.generateWebAgent', () => this.generateWebAgent()),
            vscode.commands.registerCommand('bmad.deployWebAgent', () => this.deployWebAgent()),
            vscode.commands.registerCommand('bmad.generateWebAgentSpec', () => this.generateWebAgentSpec()),
            vscode.commands.registerCommand('bmad.validateWebAgentDesign', () => this.validateWebAgentDesign()),
            vscode.commands.registerCommand('bmad.analyzeWebAgentPerformance', () => this.analyzeWebAgentPerformance()),
            vscode.commands.registerCommand('bmad.researchWebTechnologies', () => this.researchWebTechnologies()),
            vscode.commands.registerCommand('bmad.generateStyleGuide', () => this.generateStyleGuide()),
            // DocQA (Documentation Quality Assurance) commands
            vscode.commands.registerCommand('bmad.analyzeDocumentation', () => this.analyzeDocumentation()),
            vscode.commands.registerCommand('bmad.validateDocumentationStandards', () => this.validateDocumentationStandards()),
            vscode.commands.registerCommand('bmad.generateDocumentationReport', () => this.generateDocumentationReport()),
            vscode.commands.registerCommand('bmad.improveDocumentation', () => this.improveDocumentation()),
            vscode.commands.registerCommand('bmad.auditContentQuality', () => this.auditContentQuality()),
            vscode.commands.registerCommand('bmad.generateDocumentationSpec', () => this.generateDocumentationSpec()),
            vscode.commands.registerCommand('bmad.createStyleGuide', () => this.createStyleGuide()),
            vscode.commands.registerCommand('bmad.researchDocumentationBestPractices', () => this.researchDocumentationBestPractices()),
            // Chunky (Task Decomposition & Execution) commands
            vscode.commands.registerCommand('bmad.decomposeTask', () => this.decomposeTask()),
            vscode.commands.registerCommand('bmad.orchestrateExecution', () => this.orchestrateExecution()),
            vscode.commands.registerCommand('bmad.performBackgroundOptimization', () => this.performBackgroundOptimization()),
            vscode.commands.registerCommand('bmad.generateDecompositionPlan', () => this.generateDecompositionPlan()),
            vscode.commands.registerCommand('bmad.createOrchestrationFramework', () => this.createOrchestrationFramework()),
            vscode.commands.registerCommand('bmad.researchTaskManagementBestPractices', () => this.researchTaskManagementBestPractices()),
            vscode.commands.registerCommand('bmad.monitorTaskExecution', () => this.monitorTaskExecution()),
            vscode.commands.registerCommand('bmad.optimizeResourceAllocation', () => this.optimizeResourceAllocation()),
            // Synergy (Integrated Development & AI Enhancement) commands
            vscode.commands.registerCommand('bmad.validateDependenciesFutureProofing', () => this.validateDependenciesFutureProofing()),
            vscode.commands.registerCommand('bmad.performCodePolishRefinement', () => this.performCodePolishRefinement()),
            vscode.commands.registerCommand('bmad.performAIIntegrationEnhancement', () => this.performAIIntegrationEnhancement()),
            vscode.commands.registerCommand('bmad.generateIntegratedEnhancementPlan', () => this.generateIntegratedEnhancementPlan()),
            vscode.commands.registerCommand('bmad.createAIIntegrationFramework', () => this.createAIIntegrationFramework()),
            vscode.commands.registerCommand('bmad.researchIntegratedDevelopmentBestPractices', () => this.researchIntegratedDevelopmentBestPractices()),
            vscode.commands.registerCommand('bmad.monitorEnhancementProgress', () => this.monitorEnhancementProgress()),
            vscode.commands.registerCommand('bmad.optimizeProjectSynergy', () => this.optimizeProjectSynergy()),
            // Internal commands
            vscode.commands.registerCommand('bmad.internal.configurationChanged', (config) => this.onConfigurationChanged(config))
        ];
    ...
    async showProgressDetails() {
        ...
        if (statusInfo.progress) {
            ...
            await vscode.window.showInformationMessage('BMAD Workflow Progress', { modal: true, detail: details }, 'OK');
        }
        else {
    ...
    async showModeDetails() {
        ...
        if (statusInfo.mode) {
            ...
            await vscode.window.showInformationMessage('BMAD Mode Details', { modal: true, detail: details }, 'OK');
        }
        else {
    ...
    async debugCurrentFile() {
        ...
        try {
            ...
            await this.activateMode('debugMode');
            await vscode.window.showInformationMessage(`BMAD Debug Mode activated for ${editor.document.fileName}`);
        }
        catch (error) {
    ...
    async documentCurrentFile() {
        ...
        try {
            ...
            await vscode.window.showInformationMessage(`BMAD Documentation Mode activated for ${editor.document.fileName}`);
        }
        catch (error) {
    ...
    async debugSelection() {
        ...
        try {
            ...
            await vscode.window.showInformationMessage(`BMAD Debug Analysis`, { modal: true, detail: `Analyzing selected code:\n\n${selectedText.substring(0, 200)}...` }, 'Continue with Debug Mode').then(async (action) => {
    ...
    async explainCode() {
        ...
        try {
            ...
            await vscode.window.showInformationMessage(`BMAD Code Explanation`, { modal: true, detail: `Ready to explain code context. Use Documentation Mode for detailed analysis.` }, 'Start Documentation Mode').then(async (action) => {
    ...
    async generateTests() {
        ...
        try {
            ...
            await vscode.window.showInformationMessage(`BMAD Test Generation`, { modal: true, detail: `Ready to generate tests for ${editor.document.fileName}. Use Full Development Mode for comprehensive test generation.` }, 'Start Full Development Mode').then(async (action) => {
    ...
    async generateDocsForFolder() {
        try {
            ...
            await this.activateMode('documentation');
            await vscode.window.showInformationMessage('BMAD Documentation Mode activated for folder analysis');
        }
        catch (error) {
    ...
    async showHelp() {
        ...
        await vscode.window.showInformationMessage('BMAD Help', { modal: true, detail: helpContent }, 'Open Documentation', 'Quick Start').then(async (action) => {

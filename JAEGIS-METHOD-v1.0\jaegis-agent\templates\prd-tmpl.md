...
[[LLM: VALIDATION CHECKPOINT - Review shared context from previous agents and validate all inputs. Integrate web research findings and ensure current best practices. If Project Brief available, validate against current market trends.]]

## Executive Summary

[[LLM: VALIDATION CHECKPOINT - Provide 2-3 paragraph executive summary based on research and validation. Include market research findings and competitive analysis.]]

## Goals and Background Context

[[LLM: VALIDATION CHECKPOINT - Populate sections based on validated inputs and research. Include market validation and competitive analysis. Allow user to review before proceeding.]]

### Goals

[[LLM: Research-backed goals with market validation. Each goal should be supported by evidence or market research.]]
- **Primary Goal**: {{Primary validated goal with market backing}}
- **Secondary Goals**: {{Research-backed secondary goals}}
- **Success Metrics**: {{Measurable, validated success criteria}}

### Background Context

[[LLM: Include market research and competitive analysis. Reference current market trends and user research findings. 1-2 paragraphs with research citations where applicable.]]

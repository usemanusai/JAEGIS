...
from emad_auto_sync import EMADAutoSync, DEFAULT_JAEGIS_PATH, DEFAULT_MONITOR_INTERVAL
...
class EMADAutoSyncService(win32serviceutil.ServiceFramework):
    ...
    _svc_description_ = "Monitors JAEGIS-METHOD directory and automatically syncs changes to EMAD GitHub repository"
    ...
    def __init__(self, args):
        ...
        self.JAEGIS_path = Path(os.environ.get('EMAD_JAEGIS_PATH', service_dir))
    ...
    def SvcDoRun(self):
        ...
        try:
            ...
            try:
                auto_sync = EMADAutoSync(self.JAEGIS_path, self.monitor_interval)
...
def run_debug():
    ...
    JAEGIS_path = Path(os.environ.get('EMAD_JAEGIS_PATH', DEFAULT_JAEGIS_PATH))
    monitor_interval = int(os.environ.get('EMAD_MONITOR_INTERVAL', DEFAULT_MONITOR_INTERVAL))
    
    auto_sync = EMADAutoSync(JAEGIS_path, monitor_interval)

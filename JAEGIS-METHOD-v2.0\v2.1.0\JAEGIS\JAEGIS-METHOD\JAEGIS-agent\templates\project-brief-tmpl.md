...
[[LLM: VALIDATION CHECKPOINT - Review all project inputs and validate against current market trends and technology standards. Integrate web research findings for competitive analysis and technology validation.]]

## Executive Summary

[[LLM: RESEARCH INTEGRATION - Include current market analysis and validated technology choices. All project decisions must be supported by current research and competitive intelligence.]]

## Introduction / Problem Statement

[[LLM: VALIDATION CHECKPOINT - Validate problem statement against current market research and competitive analysis. Ensure problem is well-defined and supported by evidence.]]

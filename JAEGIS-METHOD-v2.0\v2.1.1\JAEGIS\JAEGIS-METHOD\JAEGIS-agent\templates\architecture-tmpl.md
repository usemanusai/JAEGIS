...
[[LLM: VALIDATION CHECKPOINT - Review shared context from PM and validate all requirements. Integrate web research findings for current architectural patterns and technology standards.]]

## Executive Summary

[[LLM: RESEARCH INTEGRATION - Include current architectural best practices and validated technology choices. All technologies must be researched for current versions and security status.]]

...
async function showWelcomeMessage(context) {
    ...
    if (!hasShownWelcome) {
        const action = await vscode.window.showInformationMessage('Welcome to BMAD AI Agent Orchestrator! Would you like to see the quick start guide?', { modal: false }, 'Show Guide', 'Quick Setup', 'Later');

...
exports.BMadInitializer = void 0;
const vscode = __importStar(require("vscode"));
const path = __importStar(require("path"));
class BMadInitializer {
    BMAD_FOLDER = 'bmad-agent';
    analyzer;
     ...
     */
    async createBmadStructure(bmadPath, analysis) {
     ...
     */
    async copyBaseTemplates(bmadPath, analysis) {
     ...
     * Create basic persona files
     */
    async createPersonaFiles(bmadPath) {
     ...
     * Create basic task files
     */
    async createTaskFiles(bmadPath) {
     ...
     */
    async createTemplateFiles(bmadPath, analysis) {
     ...
     */
    async createChecklistFiles(bmadPath) {
     ...
     * Create data files
     */
    async createDataFiles(bmadPath) {
     ...
     * Generate project-specific configuration
     */
    async generateConfiguration(bmadPath, analysis) {
        const config = {
     ...
     * Create IDE orchestrator configuration
     */
    async createIdeOrchestratorConfig(bmadPath, analysis) {
     ...
     */
    async validateExistingSetup(bmadPath) {
        ...
        if (missingFolders.length > 0) {
            const action = await vscode.window.showWarningMessage(`BMAD setup is incomplete. Missing folders: ${missingFolders.join(', ')}. Would you like to repair it?`, 'Repair Setup', 'Ignore');
...
exports.BMadInitializer = BMadInitializer;
//# sourceMappingURL=BMadInitializer.js.map
...
exports.Context7Integration = void 0;
...
class Context7Integration {
     ...
     */
    async securityResearch(packageName, version, ecosystem) {
        const query = {
     ...
     */
    async updateResearch(packageName, currentVersion, targetVersion, ecosystem) {
        const query = {
     ...
     */
    async alternativeResearch(packageName, reason, ecosystem) {
        const query = {
     ...
     */
    async makeRequest(endpoint, method, data, timeoutMs) {
...
exports.Context7Integration = Context7Integration;
//# sourceMappingURL=Context7Integration.js.map